Generated with [vike.dev/new](https://vike.dev/new) ([version 480](https://www.npmjs.com/package/create-vike/v/0.0.480)) using this command:

```sh
npm create vike@latest --- --react --hono --cloudflare
```
